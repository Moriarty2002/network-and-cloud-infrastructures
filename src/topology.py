...
class Environment(object):
    def __init__(self):
        ...
        self.cdn1 = self.net.addHost('cdn1', ip=CDNS_IP[0], mac=MAC_CDNS[0])
        self.cdn2 = self.net.addHost('cdn2', ip=CDNS_IP[1], mac=MAC_CDNS[1])
        
        
        self.h1 = self.net.addHost('h1', ip=PREMIUM_HOSTS_IP[0], mac=MAC_HOSTS[0]) # premium user
        self.h2 = self.net.addHost('h2', ip=NORMAL_HOSTS_IP[0], mac=MAC_HOSTS[1])
        self.h3 = self.net.addHost('h3', ip=NORMAL_HOSTS_IP[1], mac=MAC_HOSTS[2])
        self.h4 = self.net.addHost('h4', ip=PREMIUM_HOSTS_IP[1], mac=MAC_HOSTS[3]) # premium user
